...
1. Download the CSV data from http://data-explorer.oecd.org/s/2ay AKA https://data-explorer.oecd.org/vis?fs[0]=Topic%2C0%7CEmployment%23JOB%23&pg=40&fc=Topic&bp=true&snb=68&df[ds]=dsDisseminateFinalDMZ&df[id]=DSD_EARNINGS%40MIN2AVE&df[ag]=OECD.ELS.SAE&df[vs]=1.0&dq=......&pd=2000%2C&to[TIME_PERIOD]=false&vw=tb .  Note choose the "unfiltered" option otherwise the data does not go back before 2000.
