...
e.g. for a wind farm or farms with area of 100 km², the circumference is given by: `2 * pi * sqrt(area / pi)` (assuming a circular wind farm) = 35.4 km = 35400 m
...
[data.ts](data.ts) contains some data on wind farms.  I don't think this was used
in [EnergyExplorer v1](https://wikisim.org/wiki/1080).
